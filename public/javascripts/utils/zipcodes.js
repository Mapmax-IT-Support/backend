...
const methods = {
    ...
    neighboringRegions : () => {
        const { Manhattan, Bronx, Brooklyn, Queens, Staten } = Boroughs;
        const map = new Map()
        map.set(Manhattan, [ Manhattan, Bronx ]);
        map.set(Bronx, [ Bronx, Manhattan ]);
        map.set(Brooklyn, [ Brooklyn, Queens ]);
        map.set(Queens, [ Queens, Brooklyn ]);
        map.set(Staten, [ Staten ]);
        return map;
    },
};
