...
// add photos
router.post('/photos/add', upload.fields([{name : 'contact_photos'}, { name:'site_photos'}]), async (req, res) => {
  res.setHeader('Content-Type', 'application/json')
...
router.post('/address', async (req, res) => {
  ...
  res.setHeader('Content-Type', 'application/json')
  let data = await listings_handler.getListingByAddress(req.body.address)
  res.send(data)
})
...
router.post('/recent', async (req, res) => {
  res.setHeader('Content-Type', 'application/json')
  let data = await listings_handler.getRecentListings(req.body.start, req.body.end)
  res.send(data)
})
