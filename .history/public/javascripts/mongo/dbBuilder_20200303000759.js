...
const getBlockAllStats = async (state, county, tract, block) => {
    let allData = await citysdk.getTractAllStats(state, county, tract, block).catch(e => 'ERROR')
    let ageData = await citysdk.getTractAgeData(state, county, tract, block).catch(e => 'ERROR')
