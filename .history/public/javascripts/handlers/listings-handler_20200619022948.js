...
let methods = {
    ...
    getNearby : async function (zip, distance) {
        ...
        let nearbyListings = listings.filter((listing) => {
            ...
            console.log("DISTANCE", coords.lat, coords.lng, listing.location.coords.lat, listing.location.coords.lngcalcCrow(coords.lat, coords.lng, listing.location.coords.lat, listing.location.coords.lng))
        })
