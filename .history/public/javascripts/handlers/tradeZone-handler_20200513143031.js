...
const filterBlockGroups = async (points, outerPoints, outerIndex, geoUnit, county) => {
    ...
    console.log("tonality", points.length, fulfilledBlockGroups.length, [points[0], points[1], points[2]], [fulfilledBlockGroups[0], fulfilledBlockGroups[1], fulfilledBlockGroups[2]])
    ...
    for (let i=0; i < filteredBlockGroups.length; i++) {
        console.log("IMPORTANT_RN", filteredBlockGroups[i]) //county[0].county
